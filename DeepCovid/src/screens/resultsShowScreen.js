...
const ResultsShowScreen = ( { navigation } ) => {
    ...
    if (typeof country === 'string' || country instanceof String) {
        console.log(`(deep link) Trying to find Country: ${country}`)
        var results, searchApi, errormsg;

        [searchApi, results, errormsg] = useResults();
        // console.log(results)
        ...
        result = filterResultByCountry(country) // Redefine
